...
grafico1<-ggplot(data=ds,aes(x=ds$MinTemp,y=ds$MaxTemp))
grafico1<-grafico1+geom_point()
print(grafico1)
grafico2<-ggplot(data=ds,aes(x=ds$MinTemp,y=ds$MaxTemp,colour=ds$RainTomorrow))
...
rm(list=ls())
load("data/weatherAUS.RData")
grafico4<-ggplot(data=ds,aes(x=ds$Temp9am,y=ds$Pressure9am))
grafico4<-grafico4+geom_point()
print(grafico4)
grafico_shape<-ggplot(data=ds,aes(x=ds$Temp9am,y=ds$Pressure9am,shape=ds$RainToday))
grafico_shape<-grafico_shape+geom_point()
print(grafico_shape)
grafico_colour<-ggplot(data=ds,aes(x=ds$Temp9am,y=ds$Pressure9am,colour=ds$RainToday))
...
str(iris)
iris.grafico1<-ggplot(data=iris.tidy,aes(x=iris.tidy$Species,y=iris.tidy$Value))
iris.grafico1<-iris.grafico1+geom_point() 
print(iris.grafico1)
iris.grafico2<-ggplot(data=iris.tidy,aes(x=iris.tidy$Species,y=iris.tidy$Value,colour=iris.tidy$Part))
